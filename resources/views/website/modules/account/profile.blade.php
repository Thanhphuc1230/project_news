                            ...
                            <div class="col-sm-12 col-md-3 col-lg-3">
                                ...
                                <div class="dashboard_tab_button">
                                    ...
                                    <ul class="nav flex-column dashboard-list">
                                        <li> <a href="http://storephone.online/logout">Logout</a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-md-9 col-lg-9">
                                ...
                                <div class="tab-content dashboard_content">
                                                    ...
                                                    @foreach ($history as $item)
                                                        <tr>
                                                            ...
                                                            <td><a href="{{ route('website.detailNew', ['uuid' => $item->uuid]) }}"
                                                                    style="color:#8fbc8f">{{ $item->title }}</a></td>
                                                    ...
                                                    @foreach ($comments as $comment)
                                                        <tr>
                                                            ...
                                                            <td><a href="{{ route('website.detailNew', ['uuid' => $comment->uuid]) }}"
                                                                    style="color:#8fbc8f">{{ $comment->title }}</a></td>
                                                            <td>{{ $comment->comment }}</td>

                                                            <td>
                                                                <p style="color: red">{{ $comment->status_comment }}</p>
                                                            </td>
                                    ...
                                    <div class="tab-pane fade" id="password">
                                        <h2 class="no-margin text-bold">Bảo mật <small>Bold 20px</small></h2>
                                        <form id="contact-form" method="post"
