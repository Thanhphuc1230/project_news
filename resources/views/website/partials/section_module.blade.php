        ...
        <div class="col-md-8">
          <div class="news">
            ...
            <div class="news-block">
              ...
              <div class="item-block">
                <div class="item-image"><a class="img-link" href="#"><img class="img-responsive img-full" src="{{ asset('website/img/index_800x400-image33.jpg') }}" alt=""></a></div>
                <div class="item-content"><i class="fa fa-clock-o"></i> <span class="day"> 15 Dec</span>
                  <p><a href="#">Our's Mental Health</a></p>
                </div>
              </div>
              <div class="item-block">
                <div class="item-image"><a class="img-link" href="#"><img class="img-responsive img-full" src="{{ asset('website/img/index_800x400-image34.jpg') }}" alt=""></a></div>
                <div class="item-content"><i class="fa fa-clock-o"></i> <span class="day"> 13 Dec</span>
                  <p><a href="#">Health Magazine</a></p>
                </div>
              </div>
              <div class="item-block">
                <div class="item-image"><a class="img-link" href="#"><img class="img-responsive img-full" src="{{ asset('website/img/index_800x400-image35.jpg') }}" alt=""></a></div>
                <div class="item-content"><i class="fa fa-clock-o"></i> <span class="day"> 8 Dec</span>
                  <p><a href="#">Health Social Care</a> 
                </div>
              </div>
            </div>
            <div class="module-title">
            ...
            <div class="news-block">
              ...
              <div class="item-block">
                <div class="item-image"><a class="img-link" href="#"><img class="img-responsive img-full" src="{{ asset('website/img/index_800x400-image37.jpg') }}" alt=""></a></div>
                <div class="item-content"><i class="fa fa-clock-o"></i> <span class="day">16 Dec</span>
                  <p><a href="#">School report news day</a></p>
                </div>
              </div>
              <div class="item-block">
                <div class="item-image"><a class="img-link" href="#"><img class="img-responsive img-full" src="{{ asset('website/img/index_800x400-image38.jpg') }}" alt=""></a></div>
                <div class="item-content"><i class="fa fa-clock-o"></i> <span class="day">20 Dec</span>
                  <p><a href="#">School report news day</a></p>
                </div>
              </div>
              <div class="item-block">
                <div class="item-image"><a class="img-link" href="#"><img class="img-responsive img-full" src="{{ asset('website/img/index_800x400-image39.jpg') }}" alt=""></a></div>
                <div class="item-content"><i class="fa fa-clock-o"></i> <span class="day">22 Dec</span>
                  <p><a href="#">School report radio</a></p>
                </div>
              </div>
            </div>
          </div>
