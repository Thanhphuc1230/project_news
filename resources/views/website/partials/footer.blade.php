            ...
            <div class="col-sm-6 col-md-3">
              ...
              <div class="footer-post">
                <ul>
                  ...
                  <li>
                    <div class="item">
                      <div class="item-image"><a class="img-link" href="deals.html"><img class="img-responsive img-full" src="{{ asset('website/img/index_370x185-image14.jpg') }}" alt=""></a></div>
                      <div class="item-content">
                  ...
                  <li>
                    <div class="item">
                      <div class="item-image"><a class="img-link" href="deals.html"><img class="img-responsive img-full" src="{{ asset('website/img/food_370x185-image05.jpg') }}" alt=""></a></div>
                      <div class="item-content">
                  ...
                  <li>
                    <div class="item">
                      <div class="item-image"><a class="img-link" href="deals.html"><img class="img-responsive img-full" src="{{ asset('website/img/index_370x185-image03.jpg') }}" alt=""></a></div>
                      <div class="item-content">
            ...
            <div class="col-sm-6 col-md-3">
              ...
              <div class="footer-post">
                <ul>
                  ...
                  <li>
                    <div class="item">
                      <div class="item-image"><a class="img-link" href="deals.html"><img class="img-responsive img-full" src="{{ asset('website/img/index_370x185-image15.jpg') }}" alt=""></a></div>
                      <div class="item-content">
                  ...
                  <li>
                    <div class="item">
                      <div class="item-image"><a class="img-link" href="deals.html"><img class="img-responsive img-full" src="{{ asset('website/img/index_370x185-image08.jpg') }}" alt=""></a></div>
                      <div class="item-content">
                  ...
                  <li>
                    <div class="item">
                      <div class="item-image"><a class="img-link" href="deals.html"><img class="img-responsive img-full" src="{{ asset('website/img/index_370x185-image16.jpg') }}" alt=""></a></div>
                      <div class="item-content">
