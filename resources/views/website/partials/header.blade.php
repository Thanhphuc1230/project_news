<header id="header"> 
    ...
    <div class="container"> 
      <!-- Begin .header-logo -->
      <div class="header-logo"><a href="index.html"><img src="{{ asset('website/img/logo.png') }}"alt="Site Logo" />
      ...
      <div class="header-add-place">
        <div class="desktop-add"><a href="https://themeforest.net/item/24h-news-broadcast-news-tv-channel-news-magazine-template/18614179" target="_blank"><img src="{{ asset('website/img/banner_728x90.jpg') }}" alt=""></a></div>
      </div>
      ...
      <nav class="navbar navbar-default" id="mobile-nav">
        <div class="navbar-header">
          ...
          <div class="sidenav-header-logo"><a href="index.html"><img src="{{ asset('website/img/logo.png') }}"alt="Site Logo" />
      ...
      <div class="main-menu nav navbar-collapse collapse" id="fixed-navbar-toggle"> 
        ...
        <div class="container"> 
          ...
          <ul class="nav navbar-nav">
            ...
            <li><a href="{{ route('website.category_news',['name_cate'=>Str::of($item->name_cate)->slug("-"),'id'=>$item->id_category])}}">{{$item->name_cate}}</a> </li>
            @endforeach
            ...
            <li class="dropdown mega-dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Mega Menu</a>
              <ul class="dropdown-menu mega-dropdown-menu">
                ...
                <li class="col-sm-4">
                  ...
                  <div id="carousel-1" class="nav-slider carousel slide slide-carousel" data-ride="carousel"> 
                    ...
                    <div class="carousel-inner">
                      <div class="item active"> <a href="#"><img src="{{ asset('website/img/menu_slide-image01.jpg') }}" alt=""></a> </div>
                      <div class="item"> <img src="{{ asset('website/img/menu_slide-image02.jpg') }}" alt=""> </div>
                      <div class="item"> <img src="{{ asset('website/img/menu_slide-image03.jpg') }}" alt=""> </div>
                    </div>
                    <!-- End carousel-inner--> 
                ...
                <li class="col-sm-4">
                  ...
                  <ul class="media-list">
                    <li class="media"> <a class="pull-right" href="news.html"><img class="img-responsive" alt="" src="{{ asset('website/img/menu_small-image01.jpg') }}"></a>
                    ...
                    <li class="media"> <a class="pull-right" href="sport.html"><img src="{{ asset('website/img/menu_small-image02.jpg') }}" alt="" class="img-image media-object"></a>
                      <div class="media-body">
                    ...
                    <li class="media"> <a class="pull-right" href="health.html"><img src="{{ asset('website/img/menu_small-image03.jpg') }}" alt="" class="img-image media-object"></a>
                      <div class="media-body">
                    ...
                    <li class="media"> <a class="pull-right" href="lifestyle.html"><img src="{{ asset('website/img/menu_small-image04.jpg') }}" alt="" class="img-image media-object"></a>
                      <div class="media-body">
        ...
        <div class="container"> 
          ...
          <div class="collapse navbar-collapse nav-below-main"> 
            ...
            @php
                ...
                $id_new= request()->route('id') ;
                $data = (new HomeController())->getCategory($id_new);
            @endphp
           
            <ul class="nav navbar-nav">
              @foreach ($data['mini_category'] as $category)
                  <li><a href="watch-live.html">{{ $category->name_cate }}</a></li>
              @endforeach
