                        ...
                        <div class="white_card_body">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="category_id" >
                                    ...
                                    <option selected="" value="{{$category->parent_id}}">{{$category->name_cate}}</option>
                                    @endforeach
                                </select>
                            </div>
    ...
    @endphp
        ...
        <td>
            @php
                if($new->status == 0){
            @endphp
               <a onclick="return confirm('Xác nhận kích hoạt bài viết ?')"  href="{{ route('admin.news.unactive_news',['uuid' => $new->uuid]) }} "class="status_btn" style="background:#FA8072 !important">Unactive</a> 
            ...
            <a onclick="return confirm('Xác nhận tắt kích hoạt bài viết ?')" href="{{ route('admin.news.active_news',['uuid' => $new->uuid]) }} "class="status_btn">Active</a> 
            @php
                    }
            @endphp
        ...
        <td><div class="action_btns d-flex">
            <a href="{{ route('admin.news.edit', ['uuid' => $new->uuid]) }}" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
            <a  onclick="return confirm('Xác nhận xóa bài viết ?')"  href="{{ route('admin.news.destroy', ['uuid' => $new->uuid]) }}" class="action_btn"> <i class="fas fa-trash"></i> </a>
        </div></td>
