        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer_iner text-center">
                    <p>{{ date('Y') }}Store Phone - Designed by<a href="https://www.facebook.com/thanhphuc1230/">
                            DTP</a></p>
                </div>
            </div>
        </div>
                ...
                <li>
                    <a href="#">
                        <div class="member_thumb">
                            <img src="{{ asset('style/img/staf/1.png') }}" alt="">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <div class="member_thumb">
                            <img src="{{ asset('style/img/staf/2.png') }}" alt="">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <div class="member_thumb">
                            <img src="{{ asset('style/img/staf/3.png') }}" alt="">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <div class="member_thumb">
                            <img src="{{ asset('style/img/staf/4.png') }}" alt="">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <div class="member_thumb">
                            <img src="{{ asset('style/img/staf/5.png') }}" alt="">
                        </div>
                    </a>
                </li>
                <li>
